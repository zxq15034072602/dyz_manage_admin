<?php /* Smarty version Smarty-3.1.12, created on 2017-07-24 15:51:43
...
<?php if ($_valid && !is_callable('content_59754daa9ca452_86582739')) {function content_59754daa9ca452_86582739($_smarty_tpl) {?><div class="page">
	<div class="pageContent">
		<form method="post" enctype="multipart/form-data" action="?dir=admin&action=menu&do=updata" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
...
" src="../dyz.duyiwang.cn/img/<?php echo $_smarty_tpl->tpl_vars['img']->value;?>
