...
(function($){
	$.pdialog = {
		_op:{height:500, width:680, minH:40, minW:50, total:20, max:false, mask:false, resizable:true, drawable:true, maxable:true,minable:true,fresh:true},
		_current:null,
		_zIndex:42,
		getCurrent:function(){
			...
			return this.each(function(){
				...
				$trs.hoverClass("hover").each(function(index){
					...
					$tr.dblclick(function(){
						dbltable();
							if($tr.attr("target")=='dialog'){
								$.pdialog.open($tr.attr("lianjie"),"pdialogid",$tr.attr("ming"),{minable:false,maxable:false,resizable:false,max:false,mask:true,width:$tr.attr("kuan"),height:$tr.attr("gao")});
							}
					});
